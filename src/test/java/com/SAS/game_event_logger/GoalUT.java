...
class GoalUT {
    ...
    void getScoringTeam() {
        ...
        Team t = new Team();
        t.setName("BGU");
        Goal goal = new Goal(gameID, LocalDate.now(), 0, t, (Player) u.createUser("matan", "123456", "matan anavi", UserType.PLAYER, true));
    ...
    void setScoringTeam() {
        ...
        Team t = new Team();
        t.setName("BGU");
        Goal goal = new Goal(gameID, LocalDate.now(), 0, null, (Player) u.createUser("matan", "123456", "matan anavi", UserType.PLAYER, true));
        assertEquals("1", goal.getGameID());
